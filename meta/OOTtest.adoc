...
(heartPieces)-[:FOUND_IN {req: {20rupees}}]->(LakeHylia:area),
...
(heartPieces)-[:FOUND_IN {req: {youngLink}}]->(GerudoValley:area),
(heartPieces)-[:FOUND_IN {req: {longshot|ocarinaOfTime}}]->(GerudoFortress:area), 
(heartPieces)-[:FOUND_IN {req: {Epona}}]->(GerudoFortress:area), 
(heartPieces)-[:FOUND_IN {req: {emptyBottle|blueFire}}]->(IceCavern:area), 
